...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(SC_VIPSTATUS); // VIP Status Icon�
	export_constant(SC_AWAKENED_LV1);
	export_constant(SC_AWAKENED_LV2);
	export_constant(SC_AWAKENED_LV3);
	export_constant(SC_AWAKENED_LV4);
	export_constant(SC_AWAKENED_LV5);
	export_constant(SC_AWAKENED_LV6);
	export_constant(SC_AWAKENED_LV7);
	export_constant(SC_AWAKENED_LV8);
	export_constant(SC_AWAKENED_LV9);
	export_constant(SC_AWAKENED_LV10);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_AWAKENED_LV1); // Awakened Level 1
	export_constant(EFST_AWAKENED_LV2); // Awakened Level 2
	export_constant(EFST_AWAKENED_LV3); // Awakened Level 3
	export_constant(EFST_AWAKENED_LV4); // Awakened Level 4
	export_constant(EFST_AWAKENED_LV5); // Awakened Level 5
	export_constant(EFST_AWAKENED_LV6); // Awakened Level 6
	export_constant(EFST_AWAKENED_LV7); // Awakened Level 7
	export_constant(EFST_AWAKENED_LV8); // Awakened Level 8
	export_constant(EFST_AWAKENED_LV9); // Awakened Level 9
	export_constant(EFST_AWAKENED_LV10); // Awakened Level 10
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant_npc(JT_KAFRA_NOVA2);
	export_constant_npc(JT_S_DUMMY_LARGE1_R10);
	...
	export_constant(HAT_EF_BEAST);
	export_constant(HAT_EF_AURA_BLUE);
	export_constant(HAT_EF_AURA_GREEN);
	export_constant(HAT_EF_AURA_ORANGE);
	export_constant(HAT_EF_AURA_PINK);
	export_constant(HAT_EF_AURA_PURPLE);
	export_constant(HAT_EF_AURA_RED);
	export_constant(HAT_EF_AURA_YELLOW);
	export_constant(HAT_EF_SKILL_AWAKE);
